...
#define SC_SendMessage 52
#define SC_WaitMessage 53
#define SC_SendAnswer 54
#define SC_WaitAnswer 55
...
void HandleSendMessage(int rec , int msg , int bufferId);	


void HandleWaitMessage(int send, int msg, int bufferId);
